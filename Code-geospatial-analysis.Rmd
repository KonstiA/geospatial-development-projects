...
## Round 4
AB_r4 <- read.spss("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/AB_r4_survey.sav", to.data.frame = TRUE)
...
## Round 5
AB_r5 <- read.spss("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/AB_r5_survey.sav", to.data.frame = TRUE)
...
## Round 6
AB_r6 <- read.spss("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/AB_r6_survey.sav", to.data.frame = TRUE)
...
## Round 4
AB_r4l <- read.csv("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/AB_r4_location.csv")
AB_r4l <- AB_r4l %>%
  rename(town = twnvill)
## Round 5
AB_r5l <- read.csv("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/AB_r5_location.csv")
AB_r5l <- AB_r5l %>%
  rename(town = twnvill)
## Round 6
AB_r6l <- read.csv("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/AB_r6_location.csv")
AB_r6l <- AB_r6l %>%
  rename(town = twnvill)

# World Bank - Projects 1
WB <- read.csv("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/WB_projects.csv")
# World Bank - Projects 2
WB2 <- read_excel("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/WB_projects2.xls", skip = 2)
WB2 <- WB2 %>% rename(project_id = id) #rename primary key to match other datasets
# World Bank - Projects + Locations
WB_l <- read.csv("/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/WB_location.csv")
...
# save(AB, file = "/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/AB.RData")

# write.csv(AB, file = "/Users/konstantinassmuth/Library/Mobile Documents/com~apple~CloudDocs/3.Plan Future/2.Career&Productivity/5.Formal Education/3.Master/3.Dissertation/3.Ideas/-Datasets/AB.csv", row.names = FALSE)
